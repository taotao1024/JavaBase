...
public class DefaultSqlSessionFactoryTest {
    ...
    public void test_queryUserInfoById() {
        ...
        try {
            ...
            try {
                User user = session.selectOne("com.lsy.behaviormodeo.mediator.demo02.dao.IUserDao.queryUserInfoById", 1L);
    ...
    public void test_queryUserList() {
        ...
        try {
            ...
            try {
                User req = new User();
                req.setAge(18);
                List<User> userList = session.selectList("com.lsy.behaviormodeo.mediator.demo02.dao.IUserDao.queryUserList", req);
